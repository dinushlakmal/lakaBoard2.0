 ...
 * service and the Compose UI layer.
 */
class KeyboardViewModel : ViewModel() {
    ...
    /** Callback wired up by the IME service or simulator to commit finalized text. */
    var onCommitText: ((String) -> Unit)? = null

    /** Callback wired up by the IME service or simulator to re-render the composing word. */
    var onUpdateComposingWord: ((String) -> Unit)? = null
    var onDeleteBackward: (() -> Unit)? = null

    /** Called when a word is finalized. */
